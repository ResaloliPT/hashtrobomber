...
public class ObjectFactory {
    ...
    public static Player createPlayer(String name, int col, int row, String startImg) {
        return new Player(name, col, row, startImg);
    }
    ...
    public static Block createBlock(int col, int row) {
        ...
        boolean powerUp = powerUpProbability <= 15;
